// Interactive 3D "neural core" — a glowing wireframe icosahedron surrounded by
// orbiting nodes, representing an AI network. Responds to mouse / touch drag
// and drifts on its own when idle.
(function () {
  ...
  const nodeMat = new THREE.PointsMaterial({ color: 0x9cc4ff, size: 0.06, transparent: true, opacity: 0.9 });
  const nodes = new THREE.Points(nodeGeo, nodeMat);
  group.add(nodes);

  // A few connecting arcs from core to random nodes (synapse look)
